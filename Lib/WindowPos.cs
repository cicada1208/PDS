...
namespace Lib
{
    public class WindowPos
    {
        ...
        ///     p.WaitForInputIdle();
        ///     WindowPos.SetWindowPos(p.MainWindowHandle, (IntPtr) WindowPos.SpecialWindowHandles.HWND_TOPMOST, 0, 0, 0, 0,
        ///     WindowPos.SetWindowPosFlags.SWP_NOMOVE | WindowPos.SetWindowPosFlags.SWP_NOSIZE | WindowPos.SetWindowPosFlags.SWP_SHOWWINDOW);
        ///     </para>
        /// </remarks>
