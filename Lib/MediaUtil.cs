...
namespace Lib
{
    public class MediaUtil
    {
        ...
        public void MsgSpeech(string msgSpeech, bool show = true, bool closeSpeechAfterOK = false, string msgShow = "")
        {
            ...
            finally
            {
                if (show)
                {
                    ...
                    CustomMessageBox.Show(msgShow, MsgParam.TitlePrompt);
        ...
        /// <summary>
        /// check msg text to speech
        /// </summary>
        /// <remarks>win7 client 需安裝 
        /// Microsoft Server Speech Platform Runtime (x86)、
        /// Microsoft Server Speech Text to Speech Voice (zh-TW, HanHan)
        /// </remarks>
        public MessageBoxResult CheckMsgSpeech(string msgSpeech, bool closeSpeechAfterOK = false, string msgShow = "", string okButtonText = "確定", string cancelButtonText = "取消")
        {
            SpeechSynthesizer synth = new SpeechSynthesizer();
            ...
            {
                if (msgShow.IsNullOrWhiteSpace()) msgShow = msgSpeech;
                result = CustomMessageBox.ShowOKCancel(msgShow, MsgParam.TitlePrompt, okButtonText, cancelButtonText);
                if (closeSpeechAfterOK) synth.Dispose();
            }
        ...
        public string SpeechBedNoStr(string bedno)
        {
